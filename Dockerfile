...
RUN apt update && apt install -y qemu qemu-utils qemu-user-static binfmt-support && \
    ...
    ln -sv /usr/lib/x86_64-linux-gnu/libncursesw.so.6.3 /usr/lib/x86_64-linux-gnu/libncursesw.so.5 && \
    ln -sv /usr/lib/x86_64-linux-gnu/libncurses.so.6.3 /usr/lib/x86_64-linux-gnu/libncurses.so.5 && \
    ln -sv /usr/lib/x86_64-linux-gnu/libtinfo.so.6.3 /usr/lib/x86_64-linux-gnu/libtinfo.so.5 && \
